...
daten = np.array([
    # Szenario 1 (Photosynthese)
    [4, 5, 4, 2, 4, 5, 3, 1, 4, 5, 4, 4, 4, 1, 4, 3, 3, 2, 5],
    # Szenario 3 (Arzt)
    [2, 5, 2, 4, 5, 3, 4, 4, 5, 4, 4, 3, 2, 2, 3, 3, 4, 2, 3],
    # Szenario 4 (Computer)
    [4, 5, 4, 3, 5, 3, 4, 3, 5, 4, 3, 1, 3, 2, 4, 3, 2, 2, 3],
    # Szenario 5 (Überforderung)
    [4, 5, 4, 4, 5, 5, 4, 4, 5, 4, 2, 1, 1, 2, 4, 3, 4, 2, 5],
    # Szenario 6 (Dialog)
    [4, 5, 4, 3, 4, 5, 4, 3, 4, 4, 3, 2, 3, 4, 3, 3, 4, 3, 4]
])
