...
public class WebViewBrowser : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityTouchHandler
{
    ...
    private void Start()
    {
        ...
        webViewComponent.GetWebViewWhenReady((IWebView webView) =>
        {
            ...
            textureScale = webViewComponent.TextureScale;
        });
    }
    ...
    private void TranslatePointerToWebViewMouseEvent(MixedRealityPointerEventData eventData, WebViewMouseEventData.EventType evenType)
    {
        var hitCoord = NormalizeWorldPoint(eventData.Pointer.Result.Details.Point);

        Debug.Log(hitCoord.ToString());
        ...
        {
            X = (int)(hitCoord.x / textureScale),
            Y = (int)(hitCoord.y / textureScale),
    ...
    private void TranslateTouchToWebViewMouseEvent(HandTrackingInputEventData eventData, WebViewMouseEventData.EventType evenType)
    {
        var hitCoord = NormalizeWorldPoint(eventData.InputData);
    ...
    {
        TranslatePointerToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseDown);
    }

    public void OnPointerUp(MixedRealityPointerEventData eventData)
    {
        TranslatePointerToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseUp);
    }
    ...
    {
        TranslatePointerToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseMove);
    }

    public void OnTouchStarted(HandTrackingInputEventData eventData)
    {
        TranslateTouchToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseDown);
    }

    public void OnTouchCompleted(HandTrackingInputEventData eventData)
    {
        TranslateTouchToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseUp);
    }

    public void OnTouchUpdated(HandTrackingInputEventData eventData)
    {
        TranslateTouchToWebViewMouseEvent(eventData, WebViewMouseEventData.EventType.MouseMove);
    }
}